...
- [Step A. Commitment Generation](#step-a-commitment-generation)
  - [A.1. Clone the zkIoT repository](#a1-clone-the-zkiot-repository)
    - [A.1.1 Create an Account](#a11-create-an-account)
    - [A.1.2 Connect to Your IOT2050 Device](#a12-connect-to-your-IOT2050-device)
    - [A.1.3 Install Git](#a13-install git)
    - [A.1.4 Clone the zkIoT repository](#a14-clone-the-zkiot-repository)
  - [A.2. Register the IOT2050 Device](#a2-register-the-IOT2050-device)
    - [A.2.1 Install the Device](#a21-install-the-device)
  - [A.3. Writing a C++ program](#a3-writing-a-c-program)
  - [A.4. Compile the C++ program](#a4-compile-the-c-program)
  - [A.5. Edit `device_config.json` in the zkiot-arm-siemens-iot2050-c folder](#a5-edit-device_configjson-in-the-zkiot-folder)
...
## A.1. Register the IOT2050 Device
